...
class CollectionConfig {
	...
	static buildCollectionConfigPackage(collectionsConfigs) {
		try {
			console.log('Inside SideDB.js function buildCollectionConfigPackage')
			let content = collectionsConfigs;
			console.log("collectionsConfigs :", collectionsConfigs)
			if (typeof collectionsConfigs === 'string') {
				console.log("collectionsConfigs inside typpe string:", collectionsConfigs)
			...
			if (!Array.isArray(content) || content.length === 0) {
				console.log("collectionsConfigs inside type array :", collectionsConfigs)
